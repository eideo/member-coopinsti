 ...
 * 
 */
package com.zlebank.zplatform.member.coopinsti.test;
...
public class AccountTest extends BaseTest{
    ...
    public void accountQuery(){
       ...
       try {                                                    
           CoopInsti coopInsti= coopInstiServie.getInstiByInstiCode("300000000000014");
           System.out.println(JSONObject.fromObject(coopInsti));
        } catch (Exception e) {
